#!/usr/bin/env python3
"""Care-Approval-IQ-TDD-V3.docx — TireForge-style: cover page, running header,
...
DEST = f"{D}/Care-Approval-IQ-TDD-V3.docx"
FIG  = f"{D}/tdd-v3-figures"
...
fig(f"{D}/Care-Approval-IQ-Architecture_DesignV2.png", w=6.95)
