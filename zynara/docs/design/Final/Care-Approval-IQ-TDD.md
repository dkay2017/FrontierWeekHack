...
> Microsoft Agent-a-thon 2026 · Architect Track Submission · Healthcare Prior Authorisation · Original Work
...
`Care-Approval-IQ-Architecture_Design.svg` is the authoritative diagram.)*

**What changed from the earlier design:** the orchestration layer is a **Microsoft Agent Framework
