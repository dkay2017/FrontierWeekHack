...
**Location (revised 2026-09-05):** the new project lives in **`zynara/` alongside
...
**Kickoff done (2026-09-05):** `zynara/` scaffolded, branding locked (Zynara
Health — Care Approval IQ — "Proof beats paperwork" — logo), architecture
design doc written. See `zynara/docs/progress/STATUS.md` for live state going
forward.
